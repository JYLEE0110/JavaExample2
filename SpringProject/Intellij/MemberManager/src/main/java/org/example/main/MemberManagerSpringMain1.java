...
public class MemberManagerSpringMain1 {
    ...
    static void newCommand(String[] args) {
        ...
        MemberRegisterService2 registerService = ctx.getBean("memberRegisterService2", MemberRegisterService2.class);
        // new cool@gmail 1111 1111 COOL
        // [0]     [1]    [2]  [3]  [4]
    ...
    static void changeCommand(String[] args) {
        ...
        ChangePasswordService2 passwordService = ctx.getBean("changePasswordService2", ChangePasswordService2.class);
